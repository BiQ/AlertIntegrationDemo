...
* The process should keep track of which changes have been processed by storing a bookmark or a timestamp.
...
* The process should keep track of which notifications have been processed, by storing a bookmark or a timestamp.

In this demo most of the Notification Reader functionality is in the file [NotificationReader/Program.cs](NotificationReader/Program.cs)
